...
public class NacosConfigOverrider implements BeanFactoryPostProcessor, PriorityOrdered, EnvironmentAware {
    ...
    private NacosConfigManager createNacosConfigManager() {
        ...
        try {
            // 创建ConfigService
            com.alibaba.nacos.api.config.ConfigService configService = createConfigService();
     ...
     * 创建ConfigService
     */
    private com.alibaba.nacos.api.config.ConfigService createConfigService() throws Exception {
        ...
        return com.alibaba.nacos.api.NacosFactory.createConfigService(properties);
    }
