 ...
 */
@Slf4j
@Disabled("External email integration test; run only with explicit provider credentials")
...
public class EmailSenderTest {
     ...
     */
    @Test
    @Disabled("Requires explicit recipient and live Tencent email credentials")
